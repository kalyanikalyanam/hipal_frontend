...
export default class DineTable12 extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
		  sidebarOpen: false
...
<a href="/DineIn7"><img src="images/back_o.svg" className="b_arrow"/></a>
Table
</div>
</div>
</div>
...
<p className="mt-10 mb-10"><img src="images/table_img.png" className="table_img mt-10 mb-10"/></p>
...
<p className="table_code">Table code: 01582</p>
<a href="MenuDineIn14"><span className="btn">Next</span></a>
</div>
