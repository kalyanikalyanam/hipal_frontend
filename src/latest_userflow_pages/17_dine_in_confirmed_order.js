...
export default class DineInConfirmedOrder17 extends React.Component {
...
<a href="/DineInConfirmOrder15"><img src="images/back_o.svg" className="b_arrow"/></a>
Confirmed Order
</div>
</div>
</div>
...
<div className="ask_row mb-10">Order Participant(s) <span className="call_waiter_btn">Call Waiter</span></div>
<div className="col-lg-12 p-0 ful-row">
...
<p className="qty"><span className="cook_btn">Cooking</span></p>
</div>
