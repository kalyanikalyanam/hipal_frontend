...
export default class Landing6 extends React.Component {
	  ...
	  var ref=firebase.database().ref('dynamic_logo').orderByChild("status").equalTo("Selected");
		...
		handleSubmit = (event) => {
			...
			if (this.validator.allValid()) {
				...
				this.setState({Message:"your message has been send....."});
				...
				<div className="menu-notify">
					...
					<div className="profile-left">
						...
						<img src="images/profile-nav.svg"/>
							...
							<a href="#"  className="open1" onClick={() => this.onSetSidebarOpen()}>
						<img src="images/profile-nav.svg"/>
						</a>
					</div>
...
<div className="btn-group dropup round-f-nav">
 ...
 <img src="images/create_w.svg"/>
  ...
  <div className="dropdown-menu">
	<ul>
	<li><a className="active" href="order-food.html">
...
return (
      ...
      {/* <div className="swiper-slide">Carousel  1</div>
...
<Link to="/SelectOrderType10">
	<span>May I Take Your Order :)</span>
	</Link>
	</div>
...
<div className="item-smallbx vegitarion">
<span></span>
</div>
...
<div className="plate-box">
<div className="item-smallbx nonvegitarion">
<span></span>
</div>
<figure>
<img src="images/plate-mix.png"/>
...
<h5>₹ 240</h5>
<p>Chicken tenders with red sauce</p>
...
<h5>₹ 240</h5>
<p>Beef steak with side potatoes</p>
...
<img  src="images/submit-btn-icon.svg"/>
</div>
</a>
</div></div>
</Form>
