...
componentWillReceiveProps(nextProps, prevState) {
    ...
    console.log(plpID);
        var ref = firebase
            .database()
            .ref(`items`).orderByChild("subCategory").equalTo(plpID);
        ...
        ref.on('value', snapshot => {
            ...
            this.setState({productList: data, loading: true});
                                ...
                                <div className="shop-products-wrapper">
                                    ...
                                    <div className="tab-content">
                                            ...
                                            <div className="product-area shop-product-area">
                                                ...
                                                <div className="row">
                                                    {this.state.productList.length>0? this.state.productList.map((data, index) => {
                                                                ...
                                                                <div className="single-product-wrap">
                                                                    ...
                                                                    <div className="product_desc">
                                                                        ...
                                                                        <div className="product_desc_info">
                                                                            ...
                                                                            <h4>
                                                                                <a className="product_name" href="">{data.productName}</a>
                                                                            </h4>

                                                                            <div className="price-box">

                                                                                <span className="new-price">
                                                                                    <i className="fa fa-inr" aria-hidden="true"></i>{data.sellingPrice}</span>
                                                                        ...
                                                                        <div className="add-actions">
                                                                            ...
                                                                            <ul className="add-actions-link">
                                                                                ...
                                                                                <li>
                                                                                    ...
                                                                                    <Link to="#" onClick={this.wishListSubmit}>
