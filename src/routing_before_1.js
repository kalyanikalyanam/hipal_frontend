...
import SignUpDuplicate from './auth/signup_duplicate';
...
import QRScanner1 from './web/qr_scanner';
...
import MenuDeliverDineIn from './web_updated/menu_deliver_dinein'; 

import MenuDeliver from './web_updated/menu_deliver';

import slidemenu from './web/slidemenu';

import Inside3 from './web/Inside3';
...
class Routing extends React.Component {
        ...
        return (
            <Router>
                {/* <div className="site-wrapper"> */}
                    ...
                    <Route exact strict path="/SignUpDuplicate" component={SignUpDuplicate}/>
                    <Route exact strict path="/OtpVerify" component={OtpVerify}/>
  ...
  <Route  path="/QRScanner1" component={QRScanner1}/>
                     {/* mobile */}
                    ...
                    <Route  path="/MenuDeliverDineIn" component={MenuDeliverDineIn}/>


                    <Route  path="/MenuDeliver" component={MenuDeliver}/>
                    

                    <Route  path="/slidemenu" component={slidemenu}/>

                    <Route  path="/Inside3" component={Inside3}/>
