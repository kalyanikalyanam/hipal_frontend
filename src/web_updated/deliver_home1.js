...
export default class DeliverHome1 extends React.Component {
...
<span className="left-1"><a href="#" className="shadow_b bdr-10 p-5">Add a new location</a></span>
<span className="right-1"><a href="#" className="shadow_b bdr-10 p-5">Change location</a></span>
</div>
